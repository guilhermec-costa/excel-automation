...
while True:
    ...
    utils.extract_data(wb=wb, new_row=new_row)
    time.sleep(1.5)
            ...
            for idx, row in tqdm(col_values):
                ...
                while counter_setup < setup_for_op:
                    if wb.sheet[28, start_col_position].value in ('SIM', 'U'):
                        ...
                        used_hours += 1
                        # wb.sheet[op_line, 9].value = first_hour_date_formatted + " " + str(round(wb.sheet[34, start_col_position].value)) + "h:00"
                ...
                print("Última coluna:", wb.sheet[op_line, start_col_position].address, "\n")
